 ...
 */
@Slf4j
public class SearchLabelsCommand extends AbstractExtensionCommand<List<LabelDto>> {
  ...
  @Override
  protected List<LabelDto> invokeCommand(Integration integration, PluginCommandRQ pluginCommandRq) {
    ...
    try {
      ...
      throw new ReportPortalException(ErrorType.UNABLE_INTERACT_WITH_INTEGRATION,
          "Failed to retrieve Gitlab labels");
    }
  }
}
